...
$resultado = $propiedades->xpath("/PROPERTIES/PROPERTIE[CATEGORIA='$id']");
            ...
            <div class="row">
                ...
                <div class="image span3">
                    ...
                    <div class="content">
                        ...
                        <a href="propiedades.php?id=<?php echo $propiedad->ID;?>" title="<?php echo $propiedad->NOTA;?>"></a>
                ...
                <div class="body span6">
                    ...
                    <div class="title-price row">
                        ...
                        <div class="title span4">
                            ...
                            <h2><a href="propiedades.php?id=<?php echo $propiedad->ID;?>" title="<?php echo $propiedad->NOTA;?>"><?php echo getSubString(ucwords(strtolower($propiedad->NOTA)),50);?></a></h2>
                    ...
                    <a class="btn btn-primary arrow-right" href="propiedades.php?id=<?php echo $propiedad->ID;?>" title="<?php echo $propiedad->NOTA;?>">Ver Detalles</a>
