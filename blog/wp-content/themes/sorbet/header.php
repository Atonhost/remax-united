...
<link rel="shortcut icon" href="http://remax-united.com/assets/img/favicon.png" />
<?php wp_head(); ?>
</head>
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<div class="site-header-wrapper">
			<div class="site-branding">
				<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img id="site-logo" src="http://remax-united.com/blog/wp-content/uploads/2015/06/remaxunited.png" alt="Ir a la portada del Blog" /></a></h1>
