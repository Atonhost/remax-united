...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Social | Remax United</title>
...
if ($ressocial->num_rows > 0) {
    ...
    while($rowsocial = $ressocial->fetch_assoc()) {?>
									...
									<label class="control-label" for="<?php echo strtolower($rowsocial['nombre']);?>"><?php echo $rowsocial['nombre'];?></label>

									<div class="controls">
                                     <input value="<?php echo strtolower($rowsocial['url']);?>" placeholder="<?php echo strtolower($rowsocial['url']);?>" type="text" name="<?php echo strtolower($rowsocial['nombre']);?>" id="<?php echo strtolower($rowsocial['nombre']);?>" />
...
messages: {
facebook: {
url: "Enlace no valido http://www.url.com"
},
 flickr: {
url: "Enlace no valido http://www.url.com"
},
...
$.ajax({type: "GET",
url:"action/update_social.php",
contentType:"application/x-www-form-urlencoded",
processData: false,
data: "facebook="+$('#facebook').val()+"&flickr="+$('#flickr').val()+"&twitter="+$('#twitter').val()+"&google="+$('#google').val()+"&linkedin="+$('#linkedin').val(),
