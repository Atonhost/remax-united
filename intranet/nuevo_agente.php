...
$.ajax({type: "GET",
url:"action/add_agente.php",
contentType:"application/x-www-form-urlencoded",
processData: false,
data: "usuario="+$('#usuario').val()+"&password="+$('#password').val()+"&foto="+$('#foto').val()+"&nombre="+$('#nombre').val()+"&apellidos="+$('#apellidos').val()+"&telefono="+$('#telefono').val()+"&celular="+$('#celular').val()+"&correo="+$('#email').val()+"&estado="+$('#estado').val(),
...
$(this).html('Los Datos Fueron Registrado').addClass('alert alert-success').fadeTo(900,1);
