...
$dir="pro_".generarCodigo(6); // genera un código de 6 caracteres de longitud.
  ...
  <div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs">
      <ul class="breadcrumb">
        ...
        <li class="active">Nueva Propiedades</li>
      </ul>
      <!--.breadcrumb-->
    ...
    <div class="page-content">
      <div class="page-header position-relative">
        <h1> Nueva Propiedad <small> <i class="icon-double-angle-right"></i> ingresar Propiedad </small> </h1>
      </div>
      <!--/.page-header--> 
      ...
      <div class="row-fluid">
        <div class="span12"> 
         ...
         <input type="hidden" value="<?php echo $dir?>" id="dir" name="dir">
          ...
          <div class="control-group">
            ...
            <div class="controls">
             <textarea id="descripcion" class="input-xxlarge" name="descripcion" placeholder="descripcion" rows="5"></textarea>
            </div>
          </div>
          <div class="control-group">
            <label class="control-label" for="dormitorio">Domitorio</label>
            <div class="controls">
             <input  placeholder="Habitaciones" type="text" name="habitaciones" id="habitaciones" class="input-mini" value="0" /> <span class="help-inline"> Baños </span> <input  placeholder="Baños" type="text" name="banos" id="banos" class="input-mini" value="0" /> <span class="help-inline"> Estacionamiento </span> <input  type="text" name="esta" id="esta" class="input-mini" value="0" />
            </div>
          </div>
          <div class="control-group">
            <label class="control-label" for="precio">Precio</label>
            <div class="controls">
              <input  placeholder="precio" type="text" name="precio" id="precio" />
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input  placeholder="Area de Terreno" type="text" name="area" id="area"  />
            </div>
          </div>
          <div class="control-group">
            <label class="control-label" for="area_con">Area de  Construcción</label>
            <div class="controls">
              <input  placeholder="Area de construcion" type="text" name="area_con" id="area_con"  /><span class="help-inline"> M2 </span>
            </div>
          </div>
          <div class="control-group">
            <label class="control-label" for="distrito">Distrito</label>
            <div class="controls">
              <input  placeholder="Distrito" type="text" name="distrito" id="distrito" />
            </div>
          </div>
          <div class="control-group">
            <label class="control-label" for="ubicacion">Dirección</label>
            <div class="controls">
              <input  placeholder="Dirección" type="text" name="ubicacion" id="ubicacion" />
</div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input  placeholder="Longitud" type="text" name="lng" id="lng" class="input-small"/>
              <input  placeholder="Latitud" type="text" name="lat" id="lat"  class="input-small" />
...
if ($resPro->num_rows > 0) {
    ...
    while($rowPro = $resPro->fetch_assoc()) {?>
          ...
          <div class="form-actions">
            <button class="btn btn-info" type="submit" disabled id="boton_enviar"> <i class="icon-ok bigger-110"></i> Enviar </button>
            &nbsp; &nbsp; &nbsp;
